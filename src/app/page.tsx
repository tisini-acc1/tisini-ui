              ...
              >
                <div className="relative ">
                  <h1 className="text-sm font-semibold font-roboto text-primary">
                    How Guler fits in to Real Madrid's team - and their
                    youth-first transfer policy Guillermo Rai68 How Guler fits
                    in to Real Madrid's team - and their youth-first transfer
                    policy
                  </h1>
                  <hr />
                  ...
                  >
                    ...
                    <div className="relative ">
                      <h1 className="text-sm font-semibold font-roboto text-primary">
                        ...
                        fits in to Real Madrid's team - and their youth-first
                        transfer policy
                      </h1>
                      <hr />
                      <div className="flex items-center gap-2 text-sm">
